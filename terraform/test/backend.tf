terraform {
  backend "http" {
    address     = "https://gitlab.mindworking.local/api/v4/projects/165/terraform/state/tes-cluster"
    lock_address = "https://gitlab.mindworking.local/api/v4/projects/165/terraform/state/tes-cluster/lock"
    unlock_address = "https://gitlab.mindworking.local/api/v4/projects/165/terraform/state/tes-cluster/lock"
